...
export const Hero = () => (
  <section className="relative flex min-h-screen flex-col items-center justify-start px-4 pt-10 sm:px-6 lg:min-h-screen lg:flex-row lg:items-center lg:justify-center lg:gap-12 lg:px-8 lg:pt-0">
