...
export const Hero = () => (
  <section className="relative flex min-h-[calc(100vh-56px)] flex-col items-center justify-center gap-3 overflow-hidden pt-0 lg:min-h-screen lg:flex-row lg:gap-16 lg:pt-24">
    {/* Left Column */}
    <motion.div className="flex max-w-2xl flex-col lg:w-1/2" variants={fadeUp} initial="hidden" animate="visible">
      <Chip variant="gold" className="mb-2 bg-white/80 backdrop-blur-sm sm:mb-3">⚡ Jaipur-based performance studio</Chip>
      
      <h1 className="mb-2 font-manrope text-2xl font-bold leading-tight text-text-dark sm:mb-3 sm:text-4xl md:text-5xl lg:text-6xl">
      ...
      <p className="mb-3 text-sm text-text-gray sm:mb-4 sm:text-base lg:text-lg">
      ...
      <div className="flex flex-wrap gap-2 sm:gap-4">
        <Link href="/contact" className="rounded-full bg-gradient-to-r from-gold to-gold-dim px-4 py-2 text-xs font-bold text-white shadow-glow-gold transition-all hover:scale-105 sm:px-6 sm:py-2.5 sm:text-sm lg:px-8 lg:py-3.5">
          Get a free growth plan →
        </Link>
        <Link href="/services" className="rounded-full border border-border-gray bg-white/80 px-4 py-2 text-xs font-medium text-text-gray shadow-sm transition-all hover:border-gold/50 hover:text-gold sm:px-6 sm:py-2.5 sm:text-sm lg:px-8 lg:py-3.5">
          View services
        </Link>
      </div>
      
      <div className="mt-3 flex flex-wrap gap-1.5 sm:mt-5 sm:gap-2 lg:mt-10 lg:gap-3">
    ...
    >
      <div className="flex flex-wrap items-center justify-center gap-3 rounded-xl border border-gold/20 bg-white/80 p-3 backdrop-blur-sm sm:gap-5 sm:p-5">
        <div className="text-center">
          <p className="text-lg font-bold text-gold sm:text-xl">80+</p>
          <p className="text-[9px] text-text-light sm:text-[10px]">Campaigns</p>
        </div>
        <div className="h-5 w-px bg-border-light sm:h-6" />
        <div className="text-center">
          <p className="text-lg font-bold text-cyan-accent sm:text-xl">3.8x</p>
          <p className="text-[9px] text-text-light sm:text-[10px]">Avg ROAS</p>
        </div>
        <div className="h-5 w-px bg-border-light sm:h-6" />
        <div className="text-center">
          <p className="text-lg font-bold text-emerald-accent sm:text-xl">12.4k</p>
          <p className="text-[9px] text-text-light sm:text-[10px]">Leads</p>
        </div>
      </div>
    </motion.div>
  </section>
