...
export const WhatsAppButton = () => (
  <motion.a
    ...
    whileTap={{ scale: 0.95 }}
    className="group fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full bg-emerald-500 px-5 py-3 text-white shadow-lg hover:bg-emerald-600 md:bottom-8 md:right-8"
  >
