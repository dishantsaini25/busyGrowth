        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          <div className="rounded-3xl border border-border-light bg-white p-8 shadow-card-soft">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div><label className="mb-2 block text-sm font-medium text-text-dark">WhatsApp *</label><input type="tel" name="phone" required value={formData.phone} onChange={handleChange} className="w-full rounded-xl border border-border-gray bg-white px-4 py-3 text-text-dark focus:border-gold/50 focus:outline-none focus:ring-1 focus:ring-gold/50" placeholder="+91 93527 57834" /></div>
